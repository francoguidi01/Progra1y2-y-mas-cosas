...
#define equipos "equipos.dat"
#define jugadoresTotal "jugadores.dat"
#define jugSenior "jugadoresSenior.dat"
#define jugJunior "jugadoresJunior.dat"
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            validos=cargarArregloJugadores(nuevosJugadoeres,100);
        ...
        case 2:
            ...
            categorizarEnJuniorYSenior(nuevosJugadoeres,validos);
        ...
        case 3:
            ...
            calcularPorcentajeMayoresACiertaEdad(edadBase);
            break;
        ...
        case 4:
            ...
            mostrarEquiposPorZonas(14,30,equiposPorZona,zonaEquipos);
            break;
...
int cargarArregloJugadores(stJugador a[],int dim)
{
    ...
    while(control=='s' && i<dim)
    {
        ...
        do
        {
            ...
            scanf("%d", &aux);
            verificacionId=validarIdEquipo(aux,equipos);
...
void categorizarEnJuniorYSenior(stJugador jugadores[], int validos)
{
    ...
    int i=0;
    junior=fopen(jugJunior,"ab");
    senior=fopen(jugSenior,"ab");
...
void mostrarEquiposPorZonas(int f, int c, char equiposZona[f][c], int zona)
{
    ...
    equiposValidos=cargarArregloStringEquipos(f,c,equiposZona,zona);
