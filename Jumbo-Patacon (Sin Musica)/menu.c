...
int menuAdmin (int elecion,stCelda adl[],int validos,int posCliente, nodoArbol * arbolProd, nodoArbol * arbolProdAnulados)
{
    ...
    case 8:
        ...
        break;
    case 9:///GUARDAR DATO: guardar adl al archivo, lista productos al archivo , vaciar adl,
        ///vaciar lista de archivos y al salir abrir todo desde el archivo
        ///No funciona
    ...
    do
    {
        ...
        else if (adl[posCliente].cliente.rol==1 && posCliente!=-2)
        {
            do
            {
                ...
                eleccionMenu=sistemanavegableMenuAdmin(1,1,10,1,adl[posCliente].cliente.nombre);
