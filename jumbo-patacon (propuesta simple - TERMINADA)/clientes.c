...
{
    system("cls");
    printf("\n\t\t\t No existe el ID de usuario: %d. ", id);
    system("pause");
}
...
void modificarNombre(stCelda adl[],int posCliente)
{
    ...
    if(posCliente != -1)
    {
        ...
        fflush(stdin);
        gets(nuevoNombre);
        strcpy(adl[posCliente].cliente.nombre,nuevoNombre);
    }
    else
    {
        noExiste(adl[posCliente].cliente.idCliente);
    }
}
...
void modificarApellido(stCelda adl[],int posCliente)
{
    ...
    if(posCliente != -1)
    {
        ...
        fflush(stdin);
        gets(nuevoApellido);
        strcpy(adl[posCliente].cliente.apellido,nuevoApellido);
    }
    else
    {
        noExiste(adl[posCliente].cliente.idCliente);
...
void modificarEmail(stCelda adl[],int posCliente)
{
    ...
    if(posCliente != -1)
    {
        ...
        strcpy(adl[posCliente].cliente.mail, nuevoEmail);
...
void modificarPassword(stCelda adl[],int posCliente)
{
    ...
    if(posCliente != -1)
    {
        ...
        strcpy(adl[posCliente].cliente.password, nuevoPassword);
    }
    else
    {
        noExiste(adl[posCliente].cliente.idCliente);
...
void deArchivoACabecera2 (stCelda adl[], char archivo [], int validos, int pos, nodoArbol * arbolProductos, nodoArbol * arbolEliminados)
{
    FILE * archiCabecera=fopen(archivo,"rb");
    stPedido aux;
    nodoArbol * prodAux=inicArbol();
